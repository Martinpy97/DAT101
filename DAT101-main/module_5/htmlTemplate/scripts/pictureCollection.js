...
class TPictureCarousel extends TBootstrapComponent{
  ...
  #addCaption(aDiv, aIndex){
    const content = document.getElementById("picture-carousel-caption-template").content;
  ...
  #addPicture(aIndex){
    ...
    this.#addCaption(div, picture.caption);
  ...
  #addIndicator(aIndex){
    ...
    const dic = content.cloneNode(true);
    ...
    this.#carouselIndicators.appendChild(buttton);
