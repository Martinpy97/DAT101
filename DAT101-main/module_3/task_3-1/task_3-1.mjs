...
let daysInMonth;
if (monthName === "Januar" || monthName === "Mars" || monthName === "Mai" || monthName === "Juli" || monthName === "August" || monthName === "Oktober" || monthName === "Desember") {
  daysInMonth = 31;
} else if (monthName === "April" || monthName === "Juni" || monthName === "September" || monthName === "November") {
  daysInMonth = 30;
